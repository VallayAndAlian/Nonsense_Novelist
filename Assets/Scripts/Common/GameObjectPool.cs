...
public class GameObjectPool : MonoSingleton<GameObjectPool>
{
    ...
    /// <summary>延迟销毁物体<summary>
    public void Destory(GameObject tempGo, float delay)
    {
        //开启一个协程
        StartCoroutine(DelayThenDestroy(tempGo, delay));
    }

    /// <summary>延迟协程</summary>
    private IEnumerator DelayThenDestroy(GameObject destoryGO, float delay)
    {
        //等待一个延迟的时间
