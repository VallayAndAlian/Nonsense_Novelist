	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = half4( ( ( (i.ase_color).rgb * (tex2DNode1).rgb ) * ( i.ase_color.a * tex2DNode1.a ) ) , 0.0 );
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.SamplerNode;1;-290.5,-61;Inherit;True;Property;_MainTexture;MainTexture;0;0;Create;True;0;0;0;False;0;False;-1;None;1196385090e3b004eb76b7f6d8fb8cd2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;172.8004,27.25891;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=628729A78D078F3E6F9C96B71F7DFD349C1631A9